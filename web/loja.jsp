...
<html>
    ...
    <%
       ...
       String user;
       String nome = "Login",email = "",sobrenome="",cpf="",pix="",senha="",codVenda="0";
       if(selecao == null){
           selecao = "2";
       }
    ...
    else
    {
        ...
        List<Caixa> listaVenda = objVenda.selecionarVendaAuto(Integer.valueOf(user));
        ...
        if(codVenda.equals("0")){
            ...
            objVenda.incluir(Integer.valueOf(user));
        }
        else
        {
            dados = "S";
        ...
        <div class="row">
                    ...
                    <div class="row">  
                        ...
                        <div class="col-3 caixaProduto">
                            ...
                            <form action="CAEloja.jsp">
                                ...
                                <input type="hidden" name="codTransporte" value="1">
            ...
            <div class="col-3">
                        ...
                        <form action="CAEloja.jsp">
                            ...
                            <% }else{ %>
                                <p>Deseja iniciar um carrinho de compras?</p>
                                <input type="submit" value="Iniciar um carrinho de compras">
                                <input type="hidden" value="cadastrar" name="opcao">
                                <input type="hidden" value="<%= user %>" name="codCliente">
                            <% }}else{ %>
