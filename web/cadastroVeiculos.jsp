    ...
    <div class="row">
        ...
        <section class="carousel slide" data-bs-ride="carousel" style="float: right" id="slideshow">
            ...
            <% for(Transporte transporte:listaTransporte){
                if(transporte.getObjVeiculo().getStatus().equals("Em andamento")){
                    color="#ffcd39";
                }else if(transporte.getObjVeiculo().getStatus().equals("Parado")){
                    color="#ba2c2c";
                }else if(transporte.getObjVeiculo().getStatus().equals("Em manutenção")){
                    color="#86b7fe";}
            %>
            ...
            <a href="#slideshow" class="carousel-control-next text-decoration-none text-white fw-bold fa-2xl " data-bs-slide="next">></a>
                ...
                <% if(!lat.equals(0.00)){ %>
                <div class="row justify-content-center text-center mb-5"><div id="map" class="map col-12 border border-1 border-dark rounded-2"></div></div>
