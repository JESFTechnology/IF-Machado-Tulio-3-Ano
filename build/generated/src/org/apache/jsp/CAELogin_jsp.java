...
public final class CAELogin_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    session.setAttribute("usuario", mensagem);
    }
    response.sendRedirect("login.jsp?mensagem="+mensagem+","+session.getId());
