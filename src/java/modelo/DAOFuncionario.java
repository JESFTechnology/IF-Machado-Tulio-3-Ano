...
public class DAOFuncionario {
    ...
    public String inserir(Funcionario objFuncionario){
        String sql = "INSERT INTO funcionario (nome,salario,cargo,email,senha,nascimento,codCidade,bairro,endereco) values(?,?,?,?,?,?,?,?,?)";
        try{
            ...
            pst.setString(8, objFuncionario.getBairroFuncionario());
            pst.setString(9, objFuncionario.getEnderecoFuncionario());
    ...
    public List<Funcionario> listarFuncionario(){
        ...
        try{
            ...
            while(rs.next())
            {
                ...
                objFuncionario.setEnderecoFuncionario(rs.getString("endereco"));
    ...
    public String alterar(Funcionario objFuncionario){
        String sql = "UPDATE funcionario SET nome = ?, salario = ?, cargo = ?, email=?,codCidade=?,nascimento=?,bairro=?,endereco=? WHERE codFuncionario = ?";
            ...
            
        {
            ...
            pst.setDate(6, objConverte.converteBanco(objFuncionario.getNascimento()));
            pst.setString(7, objFuncionario.getBairroFuncionario());
            pst.setString(8, objFuncionario.getEnderecoFuncionario());
            pst.setInt(9, objFuncionario.getCodigo());
